					...
					<div class="column is-4 sidebar-section">
						<div class="content">
							...
							@foreach($related as $rel)
								@if($rel->UmdPost->post_type == "press")
									<a href="{{ url($cat . "/" . $rel->UmdTermTaxonomy->UmdTerm->slug . "/" . $rel->UmdPost->post_slug ) }}">
										<article class="media">
										  <figure class="media-right">
										    <p class="image is-64x64">
										      <img src="{{ asset('uploads/'. $rel->UmdPost->post_attachment) }}">
										    </p>
										  </figure>
										  <div class="media-content">
										    <div class="content">
										      <p>
										        <strong>{{ $rel->UmdPost->post_title }}</strong>
										        	<br>
										          {!! $rel->UmdPost->post_excerpt !!}
										        <br>
										      </p>
										    </div>
										  </div>
