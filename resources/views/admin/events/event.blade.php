...
@section('content')
			...
			<h3 class="title is-3">Modifier un Article <a class="button is-primary pull-right" href="{{ url('articles/' . $post->ID) }}" target="_blank">visualiser l'article</a></h3>

			{{ Form::open(['method' => 'put', 'url' => route('admin.events.update', $post), 'files' => true]) }}
				...
				<div class="columns">
					<div class="column is-9">
						...
						<p class="control">
							{{ Form::textarea('content', $post->post_content, ['class' => 'mce-textarea extarea']) }}
						</p>
