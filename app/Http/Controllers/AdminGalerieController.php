...
class AdminGalerieController extends Controller
{
    ...
    {
		$events = UmdPost::where('post_type', 'image')->get();
		return view('admin.galerie.images', ['events' => $events]);
    }
    /**
    ...
    public function edit($id)
    {
		...
		return view('admin.galerie.image', ['post' => $post]);
    }
    /**
